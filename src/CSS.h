...
void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>Images Server</title>"); // NOTE: 1em = 16px
  ...
  webpage += F("</style></head><body><h1>Images Server</h1>");
  webpage += F("<ul>");
  webpage += F("<li><a href='/'>Archivos</a></li>"); //Menu bar with commands
  webpage += F("<li><a href='/upload'>Subir</a></li>"); 
  webpage += F("</ul>");
}
